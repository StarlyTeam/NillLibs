...
import kr.starly.libs.inventory.inventory.StackSizeProvider;
...
public class InventoryUtils {
    ...
    public static @Nullable ItemStack getFirstPartialStack(@NotNull Inventory inventory, @NotNull ItemStack type) {
        return getFirstPartialStack(inventory, type, new boolean[inventory.getSize()]);
    }

    public static @Nullable ItemStack getFirstPartialStack(@NotNull Inventory inventory, @NotNull ItemStack type, boolean @NotNull [] blockedSlots) {
